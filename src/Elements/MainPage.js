    ...
    return (
        <>
            ...
            {/* <div>
                ...
                <div className='card'>
                    <div className='header'>
                        <h6>Question No 1<span class="badge text-bg-dark">{getStatus(2)}</span></h6>
                        <p>Date - 02-06-2024</p>
                    </div>
                    <div className='card-text'>
                        <p>If A ={"1,3,5"} and B = {"2,3"} then (i) find A B ´ and B A´ .If A ={"1,3,5"} and B = {"2,3"} then (i) find A B ´ and B A´ .If A ={"1,3,5"} and B = {"2,3"} then (i) find A B ´ and B A´ .</p>
                    </div>
                    <div className='footer'>
                        <div className='sideLeft'>
                            {sstatus == 1 ? <button className='btn btn-primary'>Mark as In Progress</button> :  <button className='btn btn-primary'>Mark as Solved</button>} 
                            
                        </div>
                        <div className='sideRight'>
                            <h6>Total Marks - 5</h6>
                            <h6 className='markScored'>Mark Scored - 5</h6>
                        </div>
                    </div>
                </div>
            </div>
            <div>
                ...
                <div className='card'>
                    <div className='header'>
                        <h6>Question No 1<span class="badge text-bg-danger">{getStatus(1)}</span></h6>
                        <p>Date - 02-06-2024</p>
                    </div>
                    <div className='card-text'>
                        <p>If A ={"1,3,5"} and B = {"2,3"} then (i) find A B ´ and B A´ .If A ={"1,3,5"} and B = {"2,3"} then (i) find A B ´ and B A´ .If A ={"1,3,5"} and B = {"2,3"} then (i) find A B ´ and B A´ .</p>
                    ...
                    <div className='footer'>
                        <div className='sideLeft'>
                            <button className='btn btn-primary'>Mark as Solved</button>
                            <button className='btn btn-primary' >Mark as In Progress</button>
                        </div>
                        <div className='sideRight'>
                            <h6>Total Marks - 5</h6>
                            <h6 className='markScored'>Mark Scored - 5</h6>
